...
;(function ($, window, undefined) {
    ...
    Grid.defaults = {
        ...
        css: {
            ...
            icon: "icon",
            iconColumns: "hr-icon__th-list",
            iconDown: "hr-icon__chevron-down",
            iconRefresh: "hr-icon__refresh",
            iconSearch: "hr-icon__search",
            iconUp: "hr-icon__chevron-up",
        ...
        templates: {
            ...
            footer: "<div id='{{ctx.id}}' class='{{css.footer}}'><div class='row'><div class='col-sm-6'><p class='{{css.infos}}'></p></div><div class='col-sm-6 text-right'><p class='{{css.pagination}}'></p></div></div></div>",
